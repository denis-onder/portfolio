      ...
      <div id="about">
        ...
        <div className="about_text">
          <p className="about_text--line">
            My name is Denis Onder, and I am a student / full-stack web
            developer currently located in Bosnia and Herzegovina.
          </p>
          <p className="about_text--line">
          ...
          <p className="about_text--line">
            If you are interested in checking out what I am currently working
            on, you can check out my
            <a
              rel="noopener noreferrer"
